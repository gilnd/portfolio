<template>
    <div class="project shadow-lg" >
        <div class="w-full rounded-sm bg-background-light p-6 flex flex-col justify-between leading-normal">
            <div>
                <div class="my-4 clearfix">
                    <font-awesome-icon class="float-left text-label-info text-4xl" :icon="parentData.icon"/>
