<template>
    <div class="bg-background-light py-6 px-8 my-4 text-label-info rounded-sm shadow-lg">
        <span class="text-label-info text-sm ">{{parentData.startDate}} - {{parentData.endDate}}</span><br>
