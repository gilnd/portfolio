...
<div class="my-2 sm:my-8">
    <div>
        <span class="text-label-title text-lg font-bold ">Hey There, i'm</span><br/>
        ...
        <div class="bg-primary-main text-primary-contrastText shadow-lg text-center rounded-sm ">
            ...
            <span class="font-bold sm:text-5xl text-3xl "> I translate great ideas into code </span>
            <span class="font-bold sm:text-5xl text-3xl"> }</span>
        </div>
    </div>
    ...
    <button class="text-primary-main rounded-sm text-lg p-4 border-2 hover:bg-transparent-primary" 
